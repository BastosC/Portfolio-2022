...
try {
    const Default = {
        defaultTabId: null,
        activeClasses: "text-white bg-emerald-600",
        inactiveClasses: "hover:text-emerald-600 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-slate-800",
        onShow: () => {},
    };
...
try {
    const Default = {
        alwaysOpen: false,
        activeClasses: "bg-gray-50 dark:bg-slate-800 text-emerald-600",
